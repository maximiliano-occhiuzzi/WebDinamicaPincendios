...
<body>
		...
		<div class="hero-content">
			<div class="hero-logo">
				<div class="flame-container">
					<i class="fas fa-fire flame-main"></i> <i
						class="fas fa-fire flame-secondary"></i>
				</div>
			</div>
			...
			<div class="hero-tagline">
				<p>
					"Tecnología para <span class="highlight">prevenir incendios</span>
	...
	<section id="challenge" class="section">
		<div class="container">
			...
			<p class="section-intro">Este año, hemos visto un incremento
				alarmante en la cantidad de incendios forestales. La crisis
				climática y la actividad humana han convertido este problema en una
				emergencia global.</p>
			...
			<div class="challenge-grid">
				<div class="challenge-card">
					...
					<p>Los incendios forestales han aumentado un 200% en la última
						década, destruyendo millones de hectáreas de ecosistemas vitales.</p>
				</div>
				...
				<div class="challenge-card">
					...
					<p>Cada incendio destruye hábitats únicos y pone en peligro
						especies que han tardado décadas en establecerse.</p>
				</div>
				...
				<div class="challenge-card">
					...
					<p>Los incendios liberan enormes cantidades de CO2, acelerando
						el cambio climático y creando un ciclo destructivo.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="statistics" class="section dark-section">
		<div class="container">
			...
			<p class="section-intro">Los datos revelan una realidad
				preocupante: la mayoría de incendios forestales son causados por
				actividad humana, no por causas naturales.</p>
			<p class="section-intro">ya que de ser por causas naturales
				frecuentemente aparecen cuando se cumple la regla de los 30. Más de
				30 grados de temperatura, más de 30 km por hora de viento y menos de
				30% de humedad relativa.</p>
				...
				<div class="chart-container">
					<div class="chart-bars">
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div class="chart-fill" data-percentage="45"
						...
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div class="chart-fill" data-percentage="35"
						...
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div class="chart-fill" data-percentage="15"
						...
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div class="chart-fill" data-percentage="5"
					...
					<div class="chart-highlight">
						...
						<p>de los incendios podrían prevenirse con mejor monitoreo y
							educación</p>
					</div>
				</div>
			</div>
	...
	<section id="project" class="section">
		<div class="container">
			...
			<p class="section-intro">Firenova es un sistema de prevención
				temprana de incendios que integra sensores ambientales, bases de
				datos y plataformas digitales para anticiparse a las condiciones de
				riesgo y generar alertas antes de que el fuego comience.</p>

			<div class="project-content">
				<div class="project-description">
					<h3>Tecnología de Vanguardia</h3>
					<p>Firenova combina sensores ambientales, bases de datos y
						plataformas digitales para anticipar condiciones de riesgo.
						Nuestro sistema analiza en tiempo real variables como temperatura,
						humedad, gases y velocidad del viento, generando alertas
						preventivas antes de que el incendio ocurra.</p>

					<ul class="feature-list">
						<li><i class="fas fa-check"></i> Monitoreo ambiental 24/7 en
							tiempo real</li>
						<li><i class="fas fa-check"></i> Alertas tempranas y
							preventivas</li>
						<li><i class="fas fa-check"></i> Visualización en mapa
							digital de Argentina</li>
						<li><i class="fas fa-check"></i> Acceso desde web y
							aplicación móvil</li>
						<li><i class="fas fa-check"></i> Sección educativa con
							consejos y números de emergencia</li>
					</ul>
				</div>
			...
			<div class="process-steps">
				...
				<div class="steps-container">
					<div class="step">
						...
						<p>Sensores de temperatura, humedad, gases y viento registran
					...
					<div class="step">
						...
						<p>Los datos se envían a una base de datos remota a través de
							conexión Wi-Fi</p>
					</div>
					...
					<div class="step">
						...
						<p>La información se muestra en una web y app con alertas
							preventivas</p>
					</div>
					...
					<div class="step">
						...
						<p>La aplicación incluye consejos de prevención y contactos de
							emergencia</p>
					</div>
				</div>
			</div>
	...
	<section id="impact" class="section dark-section">
		<div class="container">
			...
			<p class="section-intro">Proponemos un enfoque integral que no
				solo protege el medio ambiente, sino que también fortalece las
				comunidades y genera conciencia sobre la conservación.</p>
					...
					<div class="impact-items">
						<div class="impact-item">
							...
							<div class="impact-content">
								...
								<p>Protegemos millones de hectáreas de bosques, preservando
									la biodiversidad y manteniendo el equilibrio ecológico.</p>
							</div>
						</div>
						...
						<div class="impact-item">
							...
							<div class="impact-content">
								...
								<p>Al prevenir incendios, evitamos la liberación de
									toneladas de dióxido de carbono, contribuyendo a la lucha
					...
					<div class="impact-items">
						<div class="impact-item">
							...
							<div class="impact-content">
								...
								<p>Salvaguardamos vidas humanas y propiedades, brindando
									seguridad a las comunidades rurales en zonas de alto riesgo.</p>
							</div>
						</div>
						...
						<div class="impact-item">
							...
							<div class="impact-content">
								...
								<p>Desarrollamos programas de concientización que educan a
									las comunidades sobre la prevención y el cuidado ambiental.</p>
							</div>
						</div>
					</div>
	...
	<section id="contact" class="section">
		<div class="container">
			<h2>Contacto</h2>
			<p class="section-intro">¿Estás interesado en colaborar con
				nosotros? Únete a nuestra misión de prevenir incendios forestales y
				proteger nuestros ecosistemas.</p>
				...
				<div class="contact-info">
					...
					<div class="social-links">
						...
						<div class="social-icons">
							<a href="https://www.instagram.com/firenova.fatima/"
	...
	<section id="credits" class="section">
		<div class="container">
			<h2>Créditos</h2>
			<p class="section-intro">Con el apoyo de organizaciones
				comprometidas con la conservación ambiental y el desarrollo
			...
			<div class="footer-content">
				<div class="footer-section">
					...
					<div class="implementation-note">
						...
						<p>Actualmente en fase de pruebas piloto en Cordoba y CABA.
							Expansión planificada para 2025 en coordinación con autoridades
							ambientales.</p>
					</div>
				</div>
	...
	<script
		src="${pageContext.request.contextPath}/scripts/inicio/script.js"></script>
</body>
</html>